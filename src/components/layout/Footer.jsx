...
const Footer = () => {
  return (
    <footer className="w-full bg-[#091A2E] text-white relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 left-0 w-full h-full bg-[linear-gradient(45deg,transparent_25%,rgba(255,255,255,0.1)_25%,rgba(255,255,255,0.1)_50%,transparent_50%,transparent_75%,rgba(255,255,255,0.1)_75%)] bg-[length:20px_20px]"></div>
      </div>
        ...
        <div className="py-20">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Cycls</h3>
              <p className="text-gray-300 leading-relaxed mb-6">
                The definitive platform for commercial AI agents. Transform your Python code into 
                scalable, monetizable businesses with a single decorator.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">SDK Downloads</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Contact Sales</a></li>
        ...
        <div className="py-12 border-t border-white/10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-300 mb-6">
              Get the latest updates on new features, tutorials, and industry insights.
            </p>
        ...
        <div className="py-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>&copy; 2024 Cycls. All rights reserved.</span>
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 right-20 w-16 h-16 bg-blue-500/20 rounded-full blur-2xl animate-pulse"></div>
      <div className="absolute bottom-20 left-20 w-24 h-24 bg-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
    </footer>
  );
};
